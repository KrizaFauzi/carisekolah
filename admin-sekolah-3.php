...
$id = $_GET["id"];
$jbm = query("SELECT * FROM tb_profil")[0];


if(isset($_POST["submit"])){

	if(up_profil($_POST) > 0 ){
		echo 
			"<script>
		...
		echo 
            ...
            document.location.href = 'admin-sekolah-3.php';
			</script>";
	}
                        ...
                        <div class="box-content">
                            <div class="profile-editor clearfix">
                                ...
                                <div class="profile-editor-main">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <?php 
                                                       if( $jbm) {
                                                                ?>
                                                        <textarea type="text" class="form-control" id="fieldDesription"  name ="deskripsi"><?= $jbm["deskripsi"]; ?></textarea>.
                                                        <?php
                                                        }else{
                                                        ?>
                                        ...
                                        <div class="form-group form-xs-group">
                                            <button type="submit" class="btn btn-danger" name="submit" >Perbarui Profil</button>
                                        </div>
