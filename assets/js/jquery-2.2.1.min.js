...
!(function (a, b) {
  ...
  function ca(a, b, c, d, e) {
    ...
    for (l.textContent = "", o = 0; (f = m[o++]); )
      ...
      else if (((j = n.contains(f.ownerDocument, f)), (g = _(l.appendChild(f), "script")), j && aa(g), c)) for (k = 0; (f = g[k++]); ) Z.test(f.type || "") && c.push(f);
    return l;
  }
  function ga() {
    return !0;
  ...
  (n.fn = n.prototype =
    ...
    n.extend({
      ...
      each: function (a, b) {
        var c,
          d = 0;
        if (s(a)) for (c = a.length; d < c && b.call(a[d], d, a[d]) !== !1; d++);
  ...
  n.fn.extend({
    ...
    toggleClass: function (a, b) {
      ...
      return "boolean" == typeof b && "string" === c
        ...
        : this.each(function () {
            var b, d, e, f;
            if ("string" === c) for (d = 0, e = n(this), f = a.match(G) || []; (b = f[d++]); ) e.hasClass(b) ? e.removeClass(b) : e.addClass(b);
              ...
              return function () {
                c &&
                  ...
                  "abort" === a
                    ...
                    : f(Gb[h.status] || h.status, h.statusText, "text" !== (h.responseType || "text") || "string" != typeof h.responseText ? { binary: h.response } : { text: h.responseText }, h.getAllResponseHeaders()));
              };
            }),
              (h.onload = c()),
              (d = h.onerror = c("error")),
